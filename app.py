...
# Flask-Setup
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "*"}}, supports_credentials=True)  # CORS global erlaubt

# Zusätzliche CORS-Header setzen
@app.after_request
...
def chat():
    try:
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "Du bist ein hilfreicher KI-Assistent für Terminbuchung."},
